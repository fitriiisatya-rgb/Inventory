...
FAILED=0
for test in tests/mysql_smoke_test.php tests/mysql_integration_test.php tests/mysql_importer_test.php tests/mysql_void_test.php tests/mysql_security_test.php; do
    echo "=============================================================="
