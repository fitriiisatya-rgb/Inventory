...
FAILED=0
for test in tests/mysql_smoke_test.php tests/mysql_integration_test.php tests/mysql_importer_test.php tests/mysql_void_test.php tests/mysql_security_test.php tests/opening_g_data_2_test.php tests/migration_negative_stock_test.php tests/warehouse_isolation_regression_test.php tests/stock_policy_test.php tests/master_data_v2_test.php tests/stock_report_test.php tests/transaction_history_test.php tests/master_data_v2_1_test.php tests/trace_test.php tests/inventory_hpp_report_test.php tests/inventory_hpp_costing_audit_test.php tests/inventory_hpp_v23c_production_hotfix_test.php tests/inventory_hpp_v23d_cutover_test.php tests/inventory_v25_transaction_correction_test.php tests/mysql_import_xlsx_v26a_test.php tests/inventory_movement_report_v26b_test.php tests/inventory_reports_v26b_extended_test.php tests/inventory_reports_v26c_test.php tests/inventory_v26_final_gate_test.php tests/inventory_v26d_stock_card_test.php tests/inventory_v27_purchase_costing_test.php tests/inventory_v28_live_transaction_import_test.php tests/inventory_v29_minimum_stock_warehouse_test.php tests/inventory_v2_10_transaction_ux_test.php tests/inventory_v2_11a_distribution_orders_test.php tests/inventory_v2_11b_pricing_invoice_test.php tests/inventory_v2_11c_reports_print_test.php tests/inventory_v2_12_dual_count_opname_test.php tests/inventory_v2_11a_hotfix_permissions_upgrade_test.php tests/inventory_v2_12_hotfix_workflow_mode_test.php tests/inventory_v2_13_karang_tengah_test.php tests/inventory_v2_13_1_activation_lock_test.php tests/inventory_v2_13_2_delete_lock_test.php tests/inventory_v2_14_karang_tengah_cutover_test.php tests/inventory_final_hardening_test.php; do
    echo "=============================================================="
