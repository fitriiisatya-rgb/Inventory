...
const Auth = (() => {
    ...
    const ROLE_PERMISSIONS = {
        ...
        STOCK: ['INVENTORY_VIEW', 'TRANSACTION_IN_CREATE', 'TRANSACTION_OUT_CREATE', 'TRANSFER_CREATE', 'TRANSFER_RECEIVE', 'STOCK_OPNAME_MANAGE', 'STOCK_ADJUSTMENT_CREATE'],
        DIVISION: ['INVENTORY_VIEW', 'TRANSACTION_OUT_CREATE', 'PRODUCTION_CREATE'],
        ADMIN: ['*'],
        SUPERADMIN: ['*'],
    };
